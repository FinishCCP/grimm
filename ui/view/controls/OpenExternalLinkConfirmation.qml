    ...
    contentItem: Item {
        Column {
            ...
            SFText {
                ...
                wrapMode: Text.Wrap
                horizontalAlignment : Text.AlignHCenter
                //% "MWG Wallet app requires permission to open external link in the browser. This action will expose your IP to the web server. To avoid it, choose -Cancel-. You can chage your choice in app setting anytime."
