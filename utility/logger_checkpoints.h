...
#define CHECKPOINT_CREATE(SIZE) \
    MWG::CheckpointData<SIZE> COMBINE(checkpointData,__LINE__); \
    MWG::Checkpoint COMBINE(checkpoint,__LINE__)(COMBINE(checkpointData,__LINE__).items, SIZE, __FILE__, __LINE__, __FUNCTION__)

#define CHECKPOINT_ADD() assert(MWG::current_checkpoint()); *MWG::current_checkpoint()

#define CHECKPOINT(...) \
    MWG::CheckpointData<NUM_ARGS(__VA_ARGS__)> COMBINE(checkpointData,__LINE__); \
    MWG::Checkpoint COMBINE(checkpoint,__LINE__)(COMBINE(checkpointData,__LINE__).items, NUM_ARGS(__VA_ARGS__), __FILE__, __LINE__, __FUNCTION__); \
